...
#都使用VAE编码器
# class scMIC(nn.Module):
#     def __init__(self, vae1, vae2, gae1, gae2, n_node=None):
#         super(scMIC, self).__init__()
#
#         self.vae1 = vae1
#         self.vae2 = vae2
...
#
#     def forward(self, x1, adj1, x2, adj2, pretrain=False):
#         # 使用 VAE 编码器进行编码，返回均值和方差
#         mu1, log_var1 = self.vae1.encoder(x1)
#         mu2, log_var2 = self.vae2.encoder(x2)
#
#         # 使用重参数化技巧进行采样
#         z_vae1 = self.reparameterize(mu1, log_var1)
#         z_vae2 = self.reparameterize(mu2, log_var2)
#
#         # 使用 IGAE 编码器进行编码
#         z_igae1, a_igae1 = self.gae1.encoder(x1, adj1)
#         z_igae2, a_igae2 = self.gae2.encoder(x2, adj2)
...
#         z2 = self.emb_fusion(adj2, z_vae2, z_igae2)
#
#         z1_tilde = self.label_contrastive_module(z1.T)
#         z2_tilde = self.label_contrastive_module(z2.T)
#
...
#
#         # VAE 解码器解码
#         x_hat1 = self.vae1.decoder(z1)
#         x_hat2 = self.vae2.decoder(z2)
#
#         # IGAE 解码器解码
#         z_hat1, z_adj_hat1 = self.gae1.decoder(z1, adj1)
#         a_hat1 = a_igae1 + z_adj_hat1
...
#             Q2 = self.q_distribution2(z2, z_vae2, z_igae2)
#         else:
#             Q1, Q2 = None, None
#
#         # 返回 VAE 的均值和方差，用于计算 KL 散度
#         return x_hat1, z_hat1, a_hat1, x_hat2, z_hat2, a_hat2, Q1, Q2, z1, z2, cons, mu1, log_var1, mu2, log_var2
